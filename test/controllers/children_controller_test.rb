...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { Class: @child.Class, UPN: @child.UPN, forename: @child.forename, nickname: @child.nickname, surname: @child.surname }
    end
  ...
  test "should update child" do
    patch :update, id: @child, child: { Class: @child.Class, UPN: @child.UPN, forename: @child.forename, nickname: @child.nickname, surname: @child.surname }
    assert_redirected_to child_path(assigns(:child))
  end
